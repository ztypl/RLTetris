...
class Shape:
    ...
    def get_local_coord(self, dd=0):
        ...
        direction_id = (self.direction_id + 1) % 4
    ...
    def get_global_coord(self, dd=0):
        return tuple((self.cx + x, self.cy + y) for x, y in self.get_global_coord(dd))
...
class Board:
    ...
    def next_shape(self):
        ...
        self.active_shape.set_center(self.width // 2, self.height)
        self.next_shape = self.generate_shape()
